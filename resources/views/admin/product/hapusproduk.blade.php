    ...
    <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
        <div x-show="deleteModalOpen" x-transition:enter="ease-out duration-300"
            ...
            <div class="px-8 py-10 text-center">
                ...
                <h3 class="text-2xl font-extrabold text-gray-900 leading-tight mb-2">Hapus Produk?</h3>
                <p class="text-sm text-gray-500 mb-8">
                    Apakah Anda yakin ingin menghapus produk ini? Tindakan ini tidak dapat dibatalkan dan data akan
                    hilang permanen.
                </p>
