<div x-show="editModalOpen" style="display: none;" class="fixed inset-0 z-[70] overflow-y-auto"
    ...
    <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
        <div x-show="editModalOpen" x-data="{
            colors: [
            ...
            <div class="px-8 py-8">
                <div class="mb-6 relative">
                    <span
                        ...
                        Edit</span>
                    <h3 class="text-2xl font-extrabold text-gray-900 leading-tight">Edit Kategori</h3>
                </div>

                <form method="POST" :action="'{{ url('admin/kategori') }}/' + formData.id">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label
                                    ...
                                    Kategori</label>
                                <input type="text" name="nama_kategori" x-model="formData.name" required
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <template x-for="c in colors" :key="c.name">
                                        <button type="button" @click="formData.color = c.name"
                                            :class="formData.color === c.name ? 'ring-2 ring-offset-2 scale-110 ' + c.class : c
