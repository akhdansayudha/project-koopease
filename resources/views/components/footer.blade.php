        ...
        <div class="max-w-7xl mx-auto px-6 md:px-8 py-12">
            ...
            <div class="rounded-bento bg-gray-50 p-6 mb-8 border border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="flex items-center gap-4">
                        <div
                            class="w-12 h-12 bg-purple-100 rounded-2xl flex items-center justify-center text-purple-600">
            ...
            <div class="pt-8 border-t border-gray-200">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div class="flex justify-center lg:justify-end gap-6 text-sm">
                        <a href="#" class="text-gray-500 hover:text-gray-700 transition-colors">Kebijakan
                            Privasi</a>
                        <a href="#" class="text-gray-500 hover:text-gray-700 transition-colors">Syarat &
                            Ketentuan</a>
                        <a href="#" class="text-gray-500 hover:text-gray-700 transition-colors">FAQ</a>
                    </div>
                </div>
            </div>
        </div>
